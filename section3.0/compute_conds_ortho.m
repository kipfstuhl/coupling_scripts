...
n_frequencies = 16;
sampling = 10000;
R = compute_orthonormalization_matrix(n_frequencies,sampling);
...
for n_elements = N
    ...
    for i = 1:n_frequencies+1
        ...
        try
            ...
            mat = [A1 sparse(n1,n2) -(Rpar'\B1_t')';
                sparse(n2,n1) A2 (Rpar'\B2_t')';
                -Rpar'\B1 Rpar'\B2 sparse(nm,nm)];
