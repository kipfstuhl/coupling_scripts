...
n_iterations = 16;
R = compute_orthonormalization_matrix(n_iterations,10000);
...
for n_elements = N
    ...
    for i = 1:n_iterations
        ...
        Rpar = R(1:2*(i-1)+1,1:2*(i-1)+1);
        A = sparse([A1 sparse(n1,n2) -(Rpar'\B1)'; sparse(n2,n1) A2 (Rpar'\B2)'; -Rpar'\B1 Rpar'\B2 sparse(n3,n3)]);
...
save('data/globalerror.mat','globalerror');
save('data/brokenerror.mat','brokenerror');
