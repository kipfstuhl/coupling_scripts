...
for nx = n_elementsx
    ...
    for n_it = 1:10
        ...
        if (it < maxit)
            ...
            sol3 = sol_apr(indices3);
            sol4 = sol_apr(indices4);
            sol5 = sol_apr(indices5);
            ...
            err1 = compute_L2_error_velocity(fespace1_u,solstr1,exact_sol_u);
            err2 = compute_L2_error_velocity(fespace2_u,solstr2,exact_sol_u);
            err3 = compute_L2_error_velocity(fespace3_u,solstr3,exact_sol_u);
            err4 = compute_L2_error_velocity(fespace4_u,solstr4,exact_sol_u);
            err5 = compute_L2_error_velocity(fespace5_u,solstr5,exact_sol_u);
