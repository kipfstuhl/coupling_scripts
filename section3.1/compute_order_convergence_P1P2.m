...
for n_elements = N
    ...
    totalsol = A\b;
    globalerror = [globalerror compute_error(fespace,totalsol,uex,graduex,typerror)];
...
save(['data/globalerror_P1_',typerror,'.mat'],'globalerror');
save(['data/brokenerror_P2P1_',typerror,'.mat'],'brokenerror');
save(['data/error_P1_',typerror,'.mat'],'error1');
save(['data/error_P2_',typerror,'.mat'],'error2');
