...
for nel_iga = [5:2:15]
    ...
    for freq = 0:5
        ...
        dofsu2 = 2 * numel(vel_iga{1});
        dofsu3(count) = 2 * numel(vel_iga{2});
        
        dofsp1 = 2 * numel(sols_fem{2}.p);
        dofsp2 = 2 * numel(p_iga{1});
        dofsp3(count) = 2 * numel(p_iga{2});
...
save(['errs_',method_data.element_name,'_P2P1'],'dofsu1','dofsu2','dofsu3', ...
    'dofsp1','dofsp2','dofsp3','err3','h_iga')
