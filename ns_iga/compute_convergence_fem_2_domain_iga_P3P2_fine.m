    ...
    for cont = 0:deg-1
        ...
        for nel_iga = [5:5:30]
            ...
            for freq = 7
                ...
                % fespaces outlet1
                fespace_us{2} = create_fespace(mesh_out1,'P3',[1 0 1 0 0]);
                fespace_ps{2} = create_fespace(mesh_out1,'P2',[]);
                ...
                method_data.regularity   = [ cont  cont];  % Regularity of the splines (pressure space)
                ...
                err3(count,deg,cont+1) = errsu + errsp
...
save(['errs_',method_data.element_name,'_P3P2_fine'],'h_iga','err3')
