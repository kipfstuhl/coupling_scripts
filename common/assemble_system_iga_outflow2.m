function iga_structure = assemble_system_iga_outflow2 (method_data,ls,nfreqs)
...
h  = @(x, y, iside) cat(1,zeros([2,size(x)]));
g  = @(x, y, iside) cat(1,zeros([2,size(x)]));
...
iga_structure.A = Atot;
iga_structure.B = B_coupling;
iga_structure.J = J;
iga_structure.rhs = rhs;
iga_structure.nurb = nurb;
iga_structure.int_dofs = int_dofs;
iga_structure.vel = vel;
iga_structure.Ndofs = Ndofs;
iga_structure.space_v = space_v;
iga_structure.space_p = space_p;
iga_structure.geometry = geometry;
iga_structure.msh = msh;
