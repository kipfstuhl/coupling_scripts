% OP_UGRADU_V_TP: assemble a part the jacobian matrix of the convective
%   term, exploiting the tensor product structure
%
%   mat = op_ugradu_v_jac_tp (spu, spv, msh, [epsilon]);
%   [rows, cols, values] = op_ugradu_v_jac_tp (spu, spv, msh, [epsilon]);
%
% INPUT:
%
...
function varargout = op_ugradu_v_jac_tp (space1, space2, msh, u)
